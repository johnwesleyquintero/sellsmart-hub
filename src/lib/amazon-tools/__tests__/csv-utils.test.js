import { processAmazonCsv, safeParseNumber, validateAsinFormat, validateRequiredColumns, } from '../csv-utils';
describe('CSV Validation Utilities', () => {
    ...
    describe('safeParseNumber', () => {
        ...
        it('should throw on invalid numbers', () => {
            expect(() => safeParseNumber('abc', 'price')).toThrow('Invalid price value: abc');
            expect(() => safeParseNumber('123.45.67', 'rating')).toThrow('Invalid rating value: 123.45.67');
            expect(() => safeParseNumber('', 'reviews')).toThrow('Invalid reviews value: ');
        });
    ...
    describe('processAmazonCsv', () => {
        ...
        it('should throw on missing columns', () => {
            expect(() => processAmazonCsv(testData, ['missing'])).toThrow('Missing required columns: missing');
        });
    });
});

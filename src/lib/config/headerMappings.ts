...
export const reportHeaders: { [key: string]: HeaderConfig } = {
  ...
  cost: { // Note: Often appears as 'Spend' in UI reports
    canonicalName: 'cost',
    displayName: formatDisplayName('cost'),
    aliases: [formatDisplayName('cost'), 'Spend'], // Added 'Spend' as a likely alias
    description: 'Total cost of clicks (Sponsored Products) or impressions (Sponsored Display).',
  },
  attributedConversions1d: {
    ...
    description: 'Number of attributed conversion events occurring within 1 day of click on ad.',
  },
  attributedConversions7d: {
    ...
    description: 'Number of attributed conversion events occurring within 7 days of click on ad.',
  },
  attributedConversions14d: {
    ...
    description: 'Number of attributed conversion events occurring within 14 days of click on ad.',
  },
  attributedConversions30d: {
    ...
    description: 'Number of attributed conversion events occurring within 30 days of click on ad.',
  },
  attributedConversions1dSameSKU: {
    ...
    description: 'Number of attributed conversion events for the same SKU occurring within 1 day of click on ad.',
  },
  attributedConversions7dSameSKU: {
    ...
    description: 'Number of attributed conversion events for the same SKU occurring within 7 days of click on ad.',
  },
  attributedConversions14dSameSKU: {
    ...
    description: 'Number of attributed conversion events for the same SKU occurring within 14 days of click on ad.',
  },
  attributedConversions30dSameSKU: {
    ...
    description: 'Number of attributed conversion events for the same SKU occurring within 30 days of click on ad.',
  },
  attributedUnitsOrdered1d: {
    ...
    description: 'Number of units ordered occurring within 1 day of click on ad.',
  },
  attributedUnitsOrdered7d: {
    ...
    description: 'Number of units ordered occurring within 7 days of click on ad.',
  },
  attributedUnitsOrdered14d: {
    ...
    description: 'Number of units ordered occurring within 14 days of click on ad.',
  },
  attributedUnitsOrdered30d: {
    ...
    description: 'Number of units ordered occurring within 30 days of click on ad.',
  },
  attributedSales1d: {
  ...
  attributedSales14d: { // Note: Often appears as 'Sales' or 'Total Sales' in UI reports
    canonicalName: 'attributedSales14d',
    displayName: formatDisplayName('attributedSales14d'),
    aliases: [formatDisplayName('attributedSales14d'), 'Sales', 'Total Sales (14 days)'], // Added likely aliases
  ...
  attributedSales1dSameSKU: {
    ...
    description: 'Total sales for the same SKU occurring within 1 day of click on ad.',
  },
  attributedSales7dSameSKU: {
    ...
    description: 'Total sales for the same SKU occurring within 7 days of click on ad.',
  },
  attributedSales14dSameSKU: {
    ...
    description: 'Total sales for the same SKU occurring within 14 days of click on ad.',
  },
  attributedSales30dSameSKU: {
    ...
    description: 'Total sales for the same SKU occurring within 30 days of click on ad.',
  },
  attributedUnitsOrdered1dSameSKU: {
    ...
    description: 'Number of units ordered for the same SKU occurring within 1 day of click on ad.',
  },
  attributedUnitsOrdered7dSameSKU: {
    ...
    description: 'Number of units ordered for the same SKU occurring within 7 days of click on ad.',
  },
  attributedUnitsOrdered14dSameSKU: {
    ...
    description: 'Number of units ordered for the same SKU occurring within 14 days of click on ad.',
  },
  attributedUnitsOrdered30dSameSKU: {
    ...
    description: 'Number of units ordered for the same SKU occurring within 30 days of click on ad.',
  },
  ...
  attributedDetailPageViewsClicks14d: {
    ...
    description: 'Number of detail page views occurring within 14 days of click on ad.',
  },
  attributedOrdersNewToBrand14d: {
    ...
    description: 'Number of orders from new-to-brand customers occurring within 14 days of click on ad.',
  },
  attributedSalesNewToBrand14d: {
    ...
    description: 'Total sales from new-to-brand customers occurring within 14 days of click on ad.',
  },
  attributedUnitsOrderedNewToBrand14d: {
    ...
    description: 'Number of units ordered from new-to-brand customers occurring within 14 days of click on ad.',
  },
  attributedBrandedSearches14d: {
    ...
    description: 'Number of attributed branded searches occurring within 14 days of click on ad.',
  },
  viewImpressions: {
  ...
  viewAttributedConversions14d: {
    ...
    description: 'Number of view-attributed conversion events occurring within 14 days of ad view.',
  },
  viewAttributedUnitsOrdered14d: {
    ...
    description: 'Number of view-attributed units ordered occurring within 14 days of ad view.',
  },
  viewAttributedSales14d: {
    ...
    description: 'Total view-attributed sales occurring within 14 days of ad view.',
  },
  viewAttributedOrdersNewToBrand14d: {
    ...
    description: 'Number of view-attributed orders from new-to-brand customers occurring within 14 days of ad view.',
  },
  viewAttributedSalesNewToBrand14d: {
    ...
    description: 'Total view-attributed sales from new-to-brand customers occurring within 14 days of ad view.',
  },
  viewAttributedUnitsOrderedNewToBrand14d: {
    ...
    description: 'Number of view-attributed units ordered from new-to-brand customers occurring within 14 days of ad view.',
  },
  ...
  date: { // Added common 'date' field
    canonicalName: 'date',
    displayName: 'Date',
    aliases: ['Date', 'Day'],
    description: 'The date of the record (YYYY-MM-DD format preferred).',
  },
  asin: { // Added common 'asin' field
    canonicalName: 'asin',
    displayName: 'ASIN',
    aliases: ['ASIN', '(Parent) ASIN', '(Child) ASIN'],
    description: 'Amazon Standard Identification Number.',
  },
  sku: { // Added common 'sku' field
    canonicalName: 'sku',
    displayName: 'SKU',
    aliases: ['SKU', 'Seller SKU'],
    description: 'Stock Keeping Unit.',
  },
  sessions: { // Placeholder for Business Report metric
      canonicalName: 'sessions',
      displayName: 'Sessions',
      aliases: ['Sessions', 'Visits'],
      description: 'Number of unique visits to product pages (typically from Business Reports).'
  },
  pageViews: { // Placeholder for Business Report metric
      canonicalName: 'pageViews',
      displayName: 'Page Views',
      aliases: ['Page Views'],
      description: 'Total number of times product pages were viewed (typically from Business Reports).'
  },
  buyBoxPercentage: { // Placeholder for Business Report metric
      canonicalName: 'buyBoxPercentage',
      displayName: 'Buy Box Percentage',
      aliases: ['Buy Box Percentage', 'Buy Box %'],
      description: 'Percentage of time you owned the Buy Box when the product page was viewed (typically from Business Reports).'
  },
  unitsOrdered: { // Placeholder for Business Report metric (Total, not attributed)
      canonicalName: 'unitsOrdered',
      displayName: 'Units Ordered',
      aliases: ['Units Ordered', 'Total Units Ordered'],
      description: 'Total number of units ordered for the product (typically from Business Reports).'
  },
...
export function getDisplayName(canonicalName: string): string {
    const config = Object.values(reportHeaders).find(c => c.canonicalName === canonicalName);

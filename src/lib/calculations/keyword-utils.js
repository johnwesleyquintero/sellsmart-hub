export class KeywordUtils {
    ...
    static calculateVolumeScore(volume) {
        if (volume >= this.THRESHOLDS.highVolume)
            return 100;
        if (volume >= this.THRESHOLDS.mediumVolume)
            return 75;
    ...
    static prioritizeKeywords(keywords) {
        return keywords
            .map((keyword) => (Object.assign(Object.assign({}, keyword), { score: this.calculateKeywordScore(keyword) })))

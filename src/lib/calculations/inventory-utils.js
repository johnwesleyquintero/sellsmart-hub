...
export class InventoryUtils {
    ...
    static analyzeInventoryHealth(data) {
        ...
        const reorderPoint = this.calculateReorderPoint(data.averageDailySales, (_a = data.leadTime) !== null && _a !== void 0 ? _a : 0);
        const reorderQuantity = this.calculateOptimalOrderQuantity(data.averageDailySales * 365, INVENTORY_METRICS.defaultOrderCost, data.currentInventory * INVENTORY_METRICS.defaultHoldingCostPercentage);
        const status = data.currentInventory === 0

            ...
            complete: (result) => {
                ...
                try {
                    ...
                    const processedData = result.data
                        ...
                        const originalKeywords = typeof item.keywords === 'string'
            ...
            <div className="space-y-4 p-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input type="text" value={manualProduct} onChange={(e) => setManualProduct(e.target.value)} placeholder="Enter product name" className="mt-1 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"/>
                </div>
                <div>
                  <label className="text-sm font-medium">Keywords</label>
                  <Textarea value={manualKeywords} onChange={(e) => setManualKeywords(e.target.value)} placeholder="Enter comma-separated keywords" rows={4}/>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      ...
                      <div className="rounded-lg border p-3">
                        <div className="flex flex-wrap gap-2">
                          {product.originalKeywords.map((keyword, i) => (<Badge key={i} variant="outline">
                              {keyword}
                            </Badge>))}
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="rounded-lg border p-3">
                        <div className="flex flex-wrap gap-2">
                          {product.cleanedKeywords.map((keyword, i) => (<Badge key={i} variant="secondary">
                              {keyword}
                            </Badge>))}
                        </div>
                      </div>

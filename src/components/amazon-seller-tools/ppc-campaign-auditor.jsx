            ...
            complete: (result) => {
                ...
                try {
                    ...
                    if (processedData.length === 0) {
                        setError('No valid data found in CSV. Please ensure your CSV has columns: name, type, spend, sales, impressions, clicks');
                        setIsLoading(false);
                        return;
                    }
    ...
    const handleExport = () => {
        ...
        const exportData = campaigns.map((campaign) => {
            ...
            return ({
                ...
                acos: (_a = campaign.acos) === null || _a === void 0 ? void 0 : _a.toFixed(2),
                impressions: campaign.impressions,
                clicks: campaign.clicks,
                ctr: (_b = campaign.ctr) === null || _b === void 0 ? void 0 : _b.toFixed(2),
                conversionRate: (_c = campaign.conversionRate) === null || _c === void 0 ? void 0 : _c.toFixed(2),
                issues: (_d = campaign.issues) === null || _d === void 0 ? void 0 : _d.join('; '),
                recommendations: (_e = campaign.recommendations) === null || _e === void 0 ? void 0 : _e.join('; '),
            });
        });
        // Create CSV content
    ...
    return (<div className="space-y-6">
          ...
          <CardContent className="p-4">
            <div className="flex flex-col items-center justify-center gap-4 p-6 text-center">
              ...
              <div className="w-full">
                ...
                {campaigns.length > 0 && (<Button variant="outline" className="w-full mt-4" onClick={clearData}>
                    Clear Data
                  </Button>)}
              </div>
            </div>
      ...
      {campaigns.length > 0 && (<>
          ...
          <div className="space-y-4">
            {campaigns.map((campaign, index) => (<CampaignCard key={index} campaign={campaign}/>))}
          </div>
        </>)}
    </div>);
}

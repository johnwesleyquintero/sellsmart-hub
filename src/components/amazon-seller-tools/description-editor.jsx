...
export default function DescriptionEditor() {
        ...
        try {
          ...
          const processedData = results.data.map((row) => {
            ...
            return {
              ...
              characterCount:
                ((_a = productRow.description) === null || _a === void 0
                  ? void 0
                  : _a.length) || 0,
              keywordCount: (
                ((_b = productRow.description) === null || _b === void 0
                  ? void 0
                  : _b.match(/\b\w+\b/g)) || []
              ).length,
            };
  ...
  const handleDescriptionChange = (event) => {
    ...
    const updatedProduct = Object.assign(Object.assign({}, activeProduct), {
      description: value,
  ...
  const handleProductNameChange = (event) => {
    setNewProduct(
      Object.assign(Object.assign({}, newProduct), {
          ...
          <div className="flex flex-wrap gap-2">
            {products.map((product, index) => (
              <Badge
                key={index}
                variant={
                  (activeProduct === null || activeProduct === void 0
                    ? void 0

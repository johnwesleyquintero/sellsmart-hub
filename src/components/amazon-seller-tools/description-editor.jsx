...
export default function DescriptionEditor() {
        ...
        Papa.parse(file, {
            ...
            complete: (results) => {
                try {
                    ...
                    const missingColumns = requiredColumns.filter((col) => results.meta.fields ? !results.meta.fields.includes(col) : true);
                    ...
                    const processedData = results.data.map((row) => {
                        ...
                        return {
                            ...
                            characterCount: ((_a = productRow.description) === null || _a === void 0 ? void 0 : _a.length) || 0,
                            keywordCount: (((_b = productRow.description) === null || _b === void 0 ? void 0 : _b.match(/\b\w+\b/g)) || [])
                                .length,
                        };
                    });
    ...
    const handleDescriptionChange = (event) => {
        ...
        const updatedProduct = Object.assign(Object.assign({}, activeProduct), { description: value, characterCount: value.length, keywordCount: countKeywords(value), score: calculateScore(value) });
        setActiveProduct(updatedProduct);
        setProducts(products.map((p) => p.product === activeProduct.product ? updatedProduct : p));
    };
    const handleProductNameChange = (event) => {
        setNewProduct(Object.assign(Object.assign({}, newProduct), { product: event.target.value }));
    };
    const handleAsinChange = (event) => {
        setNewProduct(Object.assign(Object.assign({}, newProduct), { asin: event.target.value }));
    };
    const handleNewDescriptionChange = (event) => {
        setNewProduct(Object.assign(Object.assign({}, newProduct), { description: event.target.value }));
    };
    ...
    return (<div className="space-y-6">
            ...
            <div className="space-y-4 p-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input value={newProduct.product} onChange={(e) => setNewProduct(Object.assign(Object.assign({}, newProduct), { product: e.target.value }))} placeholder="Enter product name"/>
                </div>
                <div>
                  <label className="text-sm font-medium">ASIN (Optional)</label>
                  <Input value={newProduct.asin} onChange={(e) => setNewProduct(Object.assign(Object.assign({}, newProduct), { asin: e.target.value }))} placeholder="Enter Amazon ASIN"/>
                </div>
                <div>
                  <label className="text-sm font-medium">Description</label>
                  <Textarea value={newProduct.description} onChange={(e) => setNewProduct(Object.assign(Object.assign({}, newProduct), { description: e.target.value }))} placeholder="Enter product description" rows={3}/>
                </div>
                <form onSubmit={handleAddProduct}>
                  <input type="text" placeholder="Product Name" value={newProduct.product} onChange={handleProductNameChange}/>
                  <input type="text" placeholder="ASIN" value={newProduct.asin} onChange={handleAsinChange}/>
                  <textarea placeholder="Product Description" value={newProduct.description} onChange={handleNewDescriptionChange}/>
      ...
      {products.length > 0 && (<div className="space-y-4">
          <div className="flex flex-wrap gap-2">
            {products.map((product, index) => (<Badge key={index} variant={(activeProduct === null || activeProduct === void 0 ? void 0 : activeProduct.product) === product.product
                    ? 'default'
              ...
              <CardContent className="p-4">
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    ...
                    {activeProduct.asin && (<p className="text-sm text-muted-foreground">
                ...
                <div className="mb-4 flex flex-wrap gap-3">
                  ...
                  <div className="flex items-center gap-1 rounded-full bg-muted px-3 py-1 text-xs">
                    ...
                    <span className={(activeProduct.score || 0) >= 80
                ...
                {showPreview ? (<div className="rounded-lg border p-4">
                    ...
                    <Textarea value={activeProduct.description} onChange={(e) => handleDescriptionChange(e)} placeholder="Enter product description" rows={10} className="font-mono text-sm"/>

...
const ChartContainer = React.forwardRef((_a, ref) => {
  var { id, className, children, config } = _a,
...
${colorConfig
  .map(([key, itemConfig]) => {
    var _a;
    const color =
      ((_a = itemConfig.theme) === null || _a === void 0
        ? void 0
        : _a[theme]) || itemConfig.color;
...
const ChartTooltipContent = React.forwardRef(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (
        hideLabel ||
        !(payload === null || payload === void 0 ? void 0 : payload.length)
      ) {
        return null;
      }
      const [item] = payload;
      ...
      const value =
        !labelKey && typeof label === 'string'
          ? ((_a = config[label]) === null || _a === void 0
              ? void 0
              : _a.label) || label

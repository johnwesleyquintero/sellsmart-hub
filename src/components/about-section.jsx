...
import { Brain, Code, Database, LineChart, Loader2, Sparkles, Workflow, } from 'lucide-react';
...
export default function AboutSection() {
    ...
    useEffect(() => {
        function fetchContent() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const res = yield fetch('/api/content');
                    if (!res.ok) {
    ...
    return (<section id="about" className="container relative mx-auto px-4 py-32">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {isLoading ? (<div className="flex items-center justify-center py-12">
          ...
          </div>) : error ? (<div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-800 dark:border-red-800/30 dark:bg-red-900/20 dark:text-red-400">
            <p>{error}</p>
          </div>) : (<div className="grid gap-12 md:grid-cols-2">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    {skills.map((skill) => (<div key={skill.name} className="space-y-2">
                        ...
                        <div role="progressbar" aria-valuenow={skill.level} aria-valuemin={0} aria-valuemax={100} className="h-2 w-full rounded-full bg-gray-200">
                          <div className="h-full rounded-full bg-blue-500" style={{ width: `${skill.level}%` }}/>
                        </div>
                      </div>))}
                  </div>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    {education.map((edu, index) => (<div key={index} className="border-l-2 border-primary/20 pl-4">
                        <div className="flex items-center gap-2">
            ...
            <div>
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-8">
                    {experience.map((exp, index) => (<div key={index} className="relative border-l-2 border-primary/20 pl-4">

...
- **Validation & Header Mapping:**
  ...
  - For each uploaded file:
    ...
    - Validate: Check if all _required_ canonical headers for that file type have been successfully mapped. Return specific error messages if required headers are missing (mentioning expected aliases might be helpful).

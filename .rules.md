...
- **Lockfile:** Commit the `npm-lock.yaml` file to version control to ensure deterministic installs across all environments. **This is the single source of truth for dependencies.**
...
- Ensure the integrity of `npm-lock.yaml`.
...
- `npm-lock.yaml`: **The** dependency lockfile.
...
|                       | `.\run_tasks.bat`       | Executes predefined development tasks and automation scripts.                   | Windows batch script for task automation. |

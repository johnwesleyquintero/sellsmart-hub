...
# ▲ Bun Configuration Quality Checks

## Bun Version Validation

- Verify Bun version compatibility (>= 1.0.0)
- Check for proper Bun lockfile (bun.lockb) usage
- Ensure all scripts are Bun-compatible

## Script Validation

- Verify all scripts in package.json work with Bun
- Check for proper Bun-specific optimizations
- Validate Bun's module resolution behavior
...
| `bun dev`                                                                                                                                  | Start the Next.js development server using Bun.                                                                                                                                                                      |
| `bun build`                                                                                                                                | Build the project for production using Bun.                                                                                                                                                                          |
| `bun start`                                                                                                                                | Start the production server using Bun.                                                                                                                                                                               |
| **Code Quality Commands**                                                                                                                  |                                                                                                                                                                                                                      |
| `bun run prettier --write .`                                                                                                               | Automatically format all code files using Prettier. This enforces consistent code style and corrects syntax errors based on the project's configuration. Verify successful completion and fix any errors that arise. |
| `bun run lint`                                                                                                                             | Analyze code quality using Next.js linting. Provides detailed error reports with file paths, line numbers, and suggested fixes. Fix any errors that arise.                                                           |
| **TypeScript Commands**                                                                                                                    |                                                                                                                                                                                                                      |
| `bun run tsc --noEmit`                                                                                                                     | Type-check TypeScript code without generating output files. Provides detailed error explanations and suggested fixes. Fix any errors that arise.                                                                     |
| **Debugging Commands**                                                                                                                     |                                                                                                                                                                                                                      |
| `bun run clean`                                                                                                                            | Remove build outputs and cache.                                                                                                                                                                                      |
| `bun run clean:all`                                                                                                                        | Remove all generated files and node_modules.                                                                                                                                                                         |
| `bun run type-check`                                                                                                                       | Run TypeScript checks with error categorization.                                                                                                                                                                     |
| `bun run lint:strict`                                                                                                                      | Run ESLint with strict configuration.                                                                                                                                                                                |
| `bun run check:all`                                                                                                                        | Run all checks including format, type-check, and lint.                                                                                                                                                               |
| `bun run analyze`                                                                                                                          | Analyze the production bundle size.                                                                                                                                                                                  |
| `bun run build:debug`                                                                                                                      | Build with detailed logging for debugging purposes.                                                                                                                                                                  |
| `bun run build:trace`                                                                                                                      | Generate a build trace for debugging.                                                                                                                                                                                |
| `bun run dev:debug`                                                                                                                        | Start the development server with Node.js inspector for debugging.                                                                                                                                                   |
| `bun run start:debug`                                                                                                                      | Start the production server with debugging enabled.                                                                                                                                                                  |
| `NODE_OPTIONS='--inspect' bun dev`                                                                                                         | Debug server-side code using Node.js inspector.                                                                                                                                                                      |
| **Performance Testing Commands**                                                                                                           |                                                                                                                                                                                                                      |
| `bun run lighthouse`                                                                                                                       | Run a Lighthouse performance audit.                                                                                                                                                                                  |
...
| **Deployment Commands**                                                                                                                    |                                                                                                                                                                                                                      |
| `bun run vercel:deploy`                                                                                                                    | Deploy the project to production using Vercel.                                                                                                                                                                       |
| `bun run vercel:deploy:preview`                                                                                                            | Create a preview deployment using Vercel.                                                                                                                                                                            |
| `bun cq`                                                                                                                                   | Run Bun configuration quality checks (version compatibility, lockfile usage, script validation).                                                                                                                     |
| `bun run env:pull`                                                                                                                         | Sync environment variables.                                                                                                                                                                                          |

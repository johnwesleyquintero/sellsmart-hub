...
export const mdxComponents = {
  ...
  h3: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h3 className={cn("mt-8 mb-4 text-xl font-bold tracking-tight", className)} {...props} />
  ),
  h4: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h4 className={cn("mt-8 mb-4 text-lg font-bold tracking-tight", className)} {...props} />
  ),
  ...
  hr: ({ ...props }) => <hr className="my-8 border-muted-foreground/20" {...props} />,
  ...
  a: ({ className, ...props }: React.AnchorHTMLAttributes<HTMLAnchorElement>) => (
    <Link className={cn("font-medium underline underline-offset-4 text-primary", className)} {...props} />
  ),
  Image,
}
